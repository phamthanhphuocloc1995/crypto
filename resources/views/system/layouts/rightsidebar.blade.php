<!-- Right Sidebar -->
        ...
        <div id="sidebar-right">
            ...
            <div class="sidebar-content">
                <!-- User Info -->
                <div class="user-info">
                    <div class="user-details"><a href="{{ route('system.getProfile') }}">{{ Session('user')->User_Name }}</a><br><em>{{ Session('user')->User_ID }}</em></div>
                    <img style="width:40px;height:40px" src="{{ Session('user')->User_Avatar != '' ? asset('system/avatar').'/'.Session('user')->User_Avatar : 'https://www.w3schools.com/w3images/avatar6.png' }}" alt="Avatar">
                </div>
                <!-- END User Info -->
                ...
                <div class="sidebar-right-scroll">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li>
                            <a href="{{ route('system.getProfile') }}"><i class="fa fa-pencil-square"></i> Profile</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><i class="fa fa-envelope-o"></i> Messages</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><i class="fa fa-cog"></i> Settings</a>
                        </li>
                        <li>
                            <a href="{{ route('system.getSignout') }}"><i class="fa fa-power-off"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- END User Menu -->
